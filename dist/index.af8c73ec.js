...
})({"jye3y":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "bac1566caf8c73ec";
"use strict";
...
},{}],"2gdPp":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","chart.js/auto":"d8NN9","chartjs-plugin-zoom":"kMtu7"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kMtu7":[function(require,module,exports,__globalThis) {
/*!
...
function fixRange(range, { min, max, minLimit, maxLimit }, originalLimits) {
    ...
    if ((0, _helpers.almostEquals)(min, origMin, epsilon)) min = origMin;
    if ((0, _helpers.almostEquals)(max, origMax, epsilon)) max = origMax;
    if (min < minLimit) {
        min = minLimit;
...
function zoomScale(chart, scaleId, range, transition = 'none', trigger = 'api') {
    ...
    chart.update(transition);
    (0, _helpers.callback)(state.options.zoom?.onZoom, [
        {
            chart,
            trigger
        }
...
function getPointPosition(event, chart) {
    ...
    return (0, _helpers.getRelativePosition)(event, chart);
}
...
function mouseDown(chart, event) {
    if (chart.legend) {
        ...
        if ((0, _helpers._isPointInArea)(point, chart.legend)) return;
    }
    const state = getState(chart);
...
function startPinch(chart, state, event) {
    if (state.options.zoom.pinch.enabled) {
        const point = (0, _helpers.getRelativePosition)(event, chart);
        if ((0, _helpers.callback)(state.options.zoom.onZoomStart, [
            {
                chart,
                event,
                point
            ...
            state.scale = null;
            (0, _helpers.callback)(state.options.zoom.onZoomRejected, [
                {
                    chart,
                    event
                }
...
},{"hammerjs":"lHwvQ","chart.js/helpers":"dxsY3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lHwvQ":[function(require,module,exports,__globalThis) {
...
},{}],"dxsY3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jye3y","2gdPp"], "2gdPp", "parcelRequire94c2")

//# sourceMappingURL=index.af8c73ec.js.map
